...
function draw() {
  ...
  py1.display(rgb(229, 116, 117), "blue")
  py2.display(rgb(229, 116, 117), "blue")
  py3.display(rgb(229, 116, 117), "blue")
  py4.display(rgb(110, 71, 102), "blue")
  py5.display(rgb(110, 71, 102), "blue")
  py6.display(rgb(251, 189, 76), "blue")
  sling.display("darkgreen");
  stand1.display();
  stand2.display();
  ball.display("black", "green");
  textSize(35);
  fill(0);
}
